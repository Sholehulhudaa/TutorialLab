...
public class ActivityAutoComplete extends Activity {
    ...
    // Pembuatan array
    String[] arr = {"Aditia Got Cha", "Kulsum", "Daffa Ahmad", "Edgard Jeremiah", "Farid", "Felix", "Haidar",
            "Raihan", "Rakha"};
    @Override
...
/* Threshold merupakan fungsi untuk mengatur jumlah huruf yang harus diketikkan sebelum suggestion words untuk
autocompleteditampilkan.
